...
class _AddPageState extends State<AddPage> {
  ...
  final String baseUrl = 'http://172.22.15.230:3000'; // Replace with the IP address or hostname of your backend server
  ...
  decoration: InputDecoration(
    ...
    suffixIcon: Icon(
      ...
      size: 8.0,
            ...
            SizedBox(height: 16.0),
            isConnected
                ? Text('Data saved successfully', style: TextStyle(color: Colors.green))
                : Container(),
          ],
        ),
      ),
